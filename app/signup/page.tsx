        ...
        <div className="w-full max-w-[400px] space-y-8">
            ...
            <div className="space-y-4">
              <label className="flex items-center">
                ...
                <span className="ml-2 text-sm text-gray-600">
                  我同意 
                  <Link href="/terms" className="text-[#0066FF] hover:underline">服務條款</Link>
                  {' '}和{' '}
                  <Link href="/privacy" className="text-[#0066FF] hover:underline">隱私政策</Link>
                </span>
              </label>
            </div>
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <span className="text-gray-700 font-medium">使用 Google 帳號註冊</span>
            </button>
